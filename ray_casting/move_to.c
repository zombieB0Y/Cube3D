...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/09/25 10:06:59 by ibennaje          #+#    #+#             */
/*   Updated: 2025/09/25 10:07:01 by ibennaje         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../cube.h"

static void	move_foward(void)
{
...
{
	cube()->posx -= cos((cube()->direction * (PI_VALUE / 180)) + (PI_VALUE / 2))
	* MOVESPEED;
	cube()->posy -= sin((cube()->direction * (PI_VALUE / 180)) + (PI_VALUE / 2))
	* MOVESPEED;
